...
export class AddAssigneeToCheckMark1642455441818 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "public"."key_result_check_mark" ADD "assigned_user_id" uuid`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "public"."key_result_check_mark" DROP COLUMN "assigned_user_id"`)
  }
}
