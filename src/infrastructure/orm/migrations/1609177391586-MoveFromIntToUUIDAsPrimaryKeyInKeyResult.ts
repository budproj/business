...
export class MoveFromIntToUUIDAsPrimaryKeyInKeyResult1609177391586 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "key_result" DROP CONSTRAINT "PK_9064c5abe9ba68432934564d43f"`)
    await queryRunner.query(`ALTER TABLE "key_result" DROP COLUMN "id"`)
    await queryRunner.query(`ALTER TABLE "key_result" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`)
