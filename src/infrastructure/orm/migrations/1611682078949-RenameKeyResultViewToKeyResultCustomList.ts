...
export class RenameKeyResultViewToKeyResultCustomList1611682078949 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TYPE "key_result_view_binding_enum" RENAME TO "key_result_custom_list_binding_enum"`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TYPE "key_result_custom_list_binding_enum" RENAME TO "key_result_view_binding_enum"`)

    await queryRunner.query(`CREATE TABLE "key_result_view" AS (SELECT * FROM "key_result_custom_list")`)
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "key_result_view" ALTER COLUMN "id" SET DEFAULT uuid_generate_v4()`)

    await queryRunner.query(`ALTER TABLE "key_result_view" ALTER COLUMN "created_at" SET NOT NULL`)
    await queryRunner.query(`ALTER TABLE "key_result_view" ALTER COLUMN "created_at" SET DEFAULT now()`)

    await queryRunner.query(`ALTER TABLE "key_result_view" ALTER COLUMN "updated_at" SET NOT NULL`)
    await queryRunner.query(`ALTER TABLE "key_result_view" ALTER COLUMN "updated_at" SET DEFAULT now()`)
