...
export class UpdateNamingStrategy1605722152420 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "confidence_report" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`)
    ...
    await queryRunner.query(`ALTER TABLE "progress_report" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`)
    ...
    await queryRunner.query(`ALTER TABLE "key_result" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`)
    await queryRunner.query(`ALTER TABLE "key_result" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`)
    ...
    await queryRunner.query(`ALTER TABLE "objective" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`)
    await queryRunner.query(`ALTER TABLE "objective" ADD "updated_at" TIMESTAMP NOT NULL DEFAULT now()`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "objective" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`)
    await queryRunner.query(`ALTER TABLE "objective" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`)
    await queryRunner.query(`ALTER TABLE "objective" ADD "cycleId" integer`)
    await queryRunner.query(`ALTER TABLE "key_result" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`)
    ...
    await queryRunner.query(`ALTER TABLE "key_result" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`)
    await queryRunner.query(`ALTER TABLE "progress_report" ADD "keyResultId" integer`)
    await queryRunner.query(`ALTER TABLE "progress_report" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`)
    ...
    await queryRunner.query(`ALTER TABLE "confidence_report" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`)
