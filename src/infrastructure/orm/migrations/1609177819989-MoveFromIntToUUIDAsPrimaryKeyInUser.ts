...
export class MoveFromIntToUUIDAsPrimaryKeyInUser1609177819989 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "team_users_user" DROP CONSTRAINT "PK_1ca7d053d598bf3af832af0a82f"`)
    ...
    await queryRunner.query(`ALTER TABLE "team_users_user" DROP CONSTRAINT "PK_3c5aba0d3c5727d0994abf770f0"`)
    await queryRunner.query(
