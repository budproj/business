...
export class AddKeyResultView1605815979323 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "key_result_view" ("id" SERIAL NOT NULL, "title" character varying, "binding" "key_result_view_binding_enum", "rank" text NOT NULL DEFAULT '[]', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer, CONSTRAINT "PK_950d4d004c13f848b979c4a54b6" PRIMARY KEY ("id"))`);
