...
export class LinkCycleWithCompany1605550384815 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cycle" ADD CONSTRAINT "FK_917072384ce255f37d62264fcdb" FOREIGN KEY ("companyId") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
