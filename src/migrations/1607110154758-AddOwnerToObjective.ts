...
export class AddOwnerToObjective1607110154758 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "objective" ADD CONSTRAINT "FK_3e9e716f8dbeb75b4b8532d2145" FOREIGN KEY ("owner_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
