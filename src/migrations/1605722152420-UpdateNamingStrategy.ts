...
export class UpdateNamingStrategy1605722152420 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "objective" ADD CONSTRAINT "FK_bd6054d696adbee34dbb5bc7687" FOREIGN KEY ("cycleId") REFERENCES "cycle"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "key_result" ADD CONSTRAINT "FK_8f841800119dceb55171f1ed710" FOREIGN KEY ("teamId") REFERENCES "team"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "progress_report" ADD CONSTRAINT "FK_4b99dc1ce620819715fc4624dc6" FOREIGN KEY ("keyResultId") REFERENCES "key_result"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "confidence_report" ADD CONSTRAINT "FK_77abd95d6700ac3b4bb291fd0da" FOREIGN KEY ("keyResultId") REFERENCES "key_result"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
