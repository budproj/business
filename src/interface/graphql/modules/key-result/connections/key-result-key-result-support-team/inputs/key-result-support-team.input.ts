...
@InputType('KeyResultAddUserToSupportTeamInput', { description: 'Data required to add a user to support team' })
...
@InputType('KeyResultRemoveUserToSupportTeamInput', { description: 'Data required to remove a user to support team' })
