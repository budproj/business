...
export class ImprovesDataStructure1606311152838 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "confidence_report" ALTER COLUMN "value_previous" DROP NOT NULL`,
    )
    await queryRunner.query(`COMMENT ON COLUMN "confidence_report"."value_previous" IS NULL`)
    await queryRunner.query(
      `ALTER TABLE "confidence_report" ALTER COLUMN "key_result_id" SET NOT NULL`,
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "progress_report" ALTER COLUMN "value_previous" DROP NOT NULL`,
    )
    await queryRunner.query(`COMMENT ON COLUMN "progress_report"."value_previous" IS NULL`)
    await queryRunner.query(
      `ALTER TABLE "progress_report" ALTER COLUMN "key_result_id" SET NOT NULL`,
    )
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`COMMENT ON COLUMN "progress_report"."key_result_id" IS NULL`)
    await queryRunner.query(
      `ALTER TABLE "progress_report" ALTER COLUMN "key_result_id" DROP NOT NULL`,
    )
    await queryRunner.query(`COMMENT ON COLUMN "progress_report"."value_previous" IS NULL`)
    await queryRunner.query(
      `ALTER TABLE "progress_report" ALTER COLUMN "value_previous" SET NOT NULL`,
    )
    await queryRunner.query(
      `ALTER TABLE "progress_report" ADD CONSTRAINT "FK_171639bc8c15479933be60eefec" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    ...
    await queryRunner.query(`COMMENT ON COLUMN "confidence_report"."key_result_id" IS NULL`)
    await queryRunner.query(
      `ALTER TABLE "confidence_report" ALTER COLUMN "key_result_id" DROP NOT NULL`,
    )
    await queryRunner.query(`COMMENT ON COLUMN "confidence_report"."value_previous" IS NULL`)
    await queryRunner.query(
      `ALTER TABLE "confidence_report" ALTER COLUMN "value_previous" SET NOT NULL`,
    )
    await queryRunner.query(
      `ALTER TABLE "confidence_report" ADD CONSTRAINT "FK_253a46d45187cc3e3eda9efa3de" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
